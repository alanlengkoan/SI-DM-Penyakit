      ...
      <div class="col-lg-12">
        ...
        <div class="single-product-pr">
          ...
          <div class="all-form-element-inner">
            <?php echo form_open('admin/ubahnmapenyakit'); ?>
            <div class="form-group-inner">
              <div class="row">
                ...
                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                  <?php echo form_input('inpidpenyakit', $penyakit['id_penyakit'], array('class' => 'form-control', 'required' => 'required', 'readonly' => 'readonly')); ?>
                </div>
              </div>
            </div>
            <div class="form-group-inner">
