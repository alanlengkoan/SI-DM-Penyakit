                  ...
                  echo "<tr>";
                    ...
                    echo "<td width='130' align='center'>
                      <div class='btn-group btn-custom-groups btn-custom-groups-one'>
                        ".anchor('admin/formubahnmapenyakit/'.$row['id_penyakit'], '<i class="fa fa-edit"></i>', array('class' => 'btn btn-success'))."
                        ".anchor('#', '<i class="fa fa-trash"></i>', array('class' => 'btn btn-danger', 'data-href' => 'hapusdatanmapenyakit/'.$row['id_penyakit'], 'data-toggle' => 'modal', 'data-target' => '#modalHapus'))."
                      </div>
                    </td>";
                    echo "</tr>";
                  }
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Tambah Nama Penyakit</h4>
      </div>
      <div class="modal-body">

        <div class="all-form-element-inner">
          <?php echo form_open('admin/tmhnmapenyakit'); ?>
