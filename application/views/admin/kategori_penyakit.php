            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
              <div class="breadcomb-wp">
                ...
                <div class="breadcomb-ctn">
                  ...
                  <!-- tombol modal tambah -->
                  <a href="#" class="btn btn-custon-rounded-three btn-default" data-toggle="modal" data-target="#modalTambah"><i class="fa fa-plus-circle" aria-hidden="true"></i> Kategori Penyakit</a>
                  <!-- tombol modal tambah -->
                </div>
        ...
        <div class="single-product-pr">
          ...
          if (isset($_GET['tambah'])) {
            ...
            <div class='alert alert-success alert-success-style1'>
              ...
              <p><strong>Berhasil!</strong> Data Kategori Penyakit Berhasil ditambahkan.</p>
            </div>
            ";
            ...
            <div class='alert alert-info alert-success-style2'>
              ...
              <i class='fa fa-check adminpro-checked-pro admin-check-pro' aria-hidden='true'></i>
              <p><strong>Berhasil!</strong> Data Kategori Penyakit Berhasil diubah.</p>
            </div>
            ";
            ...
            <div class='alert alert-danger alert-mg-b alert-success-style4'>
              ...
              <i class='fa fa-check adminpro-checked-pro admin-check-pro' aria-hidden='true'></i>
              <p><strong>Berhasil!</strong> Data Kategori Penyakit Berhasil dihapus.</p>
            </div>
            ";
            ...
            <div class='alert alert-danger alert-mg-b alert-success-style4'>
              ...
              <i class='fa fa-check adminpro-checked-pro admin-check-pro' aria-hidden='true'></i>
              <p><strong>Gagal!</strong> Mengubah Data Kategori Penyakit.</p>
            </div>
            ";
          }
          ...
          <div class="table-responsive">
            <table id="example" class="table table-hover" style="width:100%">
              ...
              <tbody>
                ...
                foreach ($kategoripenyakit as $row) {
                  echo "<tr>";
                  echo "<td>".$row['id_kategori_penyakit']."</td>";
                  ...
                  ".anchor('#', '<i class="fa fa-edit"></i>', array('class' => 'btn btn-info', 'data-id' => $row['id_kategori_penyakit'], 'data-toggle' => 'modal', 'data-target' => '#modalUbah'))."
                  ".anchor('#', '<i class="fa fa-trash"></i>', array('class' => 'btn btn-danger', 'data-href' => 'katpen/hapusdata/'.$row['id_kategori_penyakit'], 'data-toggle' => 'modal', 'data-target' => '#modalHapus'))."
                  </div>
                  </td>";
                  echo "</tr>";
                }
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Tambah Kategori Penyakit</h4>
      </div>
      <div class="modal-body">

        <div class="all-form-element-inner">
          <?php echo form_open('katpen/tambahdata'); ?>
          ...
          <div class="form-group-inner">
            <div class="row">
              ...
              <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                <?php echo form_input('inpkategoripenyakit', '', array('placeholder' => 'Kategori Penyakit', 'class' => 'form-control', 'required' => 'required')); ?>
                <div class="help-block with-errors">
...
<div class="modal fade" id="modalUbah" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title" id="myModalLabel">Ubah Kategori Penyakit</h4>
      </div>
      <div class="modal-body">
        <div id="form-input">
          <!-- isi form ubah -->
...
<div class="modal fade" id="modalHapus" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Apakah Anda Yakin Ingin menghapus kategori penyakit ini?
      </div>
...
<script type="text/javascript">
  $(document).ready(function () {
    ...
    $('#modalUbah').on('show.bs.modal', function (e) {
      var id_kategori_penyakit = $(e.relatedTarget).data('id');

      $.ajax({
        type: 'post',
        url: '<?php echo base_url("katpen/formubahdata"); ?>',
        data: {id_kategori_penyakit: id_kategori_penyakit},
