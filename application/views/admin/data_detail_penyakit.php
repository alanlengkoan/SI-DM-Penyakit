        ...
        <div class="col-lg-12">
          <div class="single-product-pr">
            ...
            <ul class="nav nav-tabs">
              <li role="presentation" class="active"> <a href="#datadetail" data-toggle="tab">Data Detail</a> </li>
              <li role="presentation"> <a href="#datagrafik" data-toggle="tab">Data Grafik</a> </li>
            </ul>
            ...
            <div class="tab-content">
              <div class="tab-pane fadein active" id="datadetail">
                <h3>Data Detail</h3>
                <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="table-responsive">
                      ...
                      <div class="tab-pane fade" id="datagrafik">
                        <h3>Data Grafik</h3>
                        <div class="row">
                          <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            $sql1 = "SELECT SUM(jenis_kelamin = 'L') AS laki_laki FROM tb_nama_penyakit WHERE YEAR(tanggal) = '$tahun' AND jenis_kelamin = 'L'";
                            $result1 = $this->db->query($sql1)->row_array();

                            $sql2 = "SELECT SUM(jenis_kelamin = 'P') AS perempuan FROM tb_nama_penyakit WHERE YEAR(tanggal) = '$tahun' AND jenis_kelamin = 'P'";
                            ...
                            <script type="text/javascript">
                              ...
                              Highcharts.chart('container1', {
                                ...
                                title: {
                                  text: 'Jumlah Penderita Penyakit Laki - laki dan Perempuan Pada Tahun <?php echo $tahun; ?>'
                                },
                                tooltip: {
                                ...
                                series: [{
                                  ...
                                  data: [{
                                    name: 'Laki - laki',
                                    y: <?php echo $result1['laki_laki']; ?>
                                  }, {
                                    name: 'Perempuan',
                                    y: <?php echo $result2['perempuan']; ?>
                                  }]
                                }]
                              });
                            </script>
                        ...
                        <div class="row">
                          <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            foreach ($result1 as $key => $value) {
                              ...
                              $nm_penyakit[$key] = $value['nama_penyakit'];
                              foreach ($result1 as $value1) {
                                $jm_penderita[$key] = $value1['jumlah_penderita'];
                              }
                            }

                            // untuk nama penyakit
                            $np = json_encode($nm_penyakit);
                            // untuk jumlah penderita
                            $jp = json_encode($jm_penderita, JSON_NUMERIC_CHECK);
                            ...
                            <br />
                            <button class="btn btn-default" id="plain1">Plain</button>
                            <button class="btn btn-default" id="inverted1">Inverted</button>
                            <button class="btn btn-default" id="polar1">Polar</button>

                            <script type="text/javascript">
                              var chart1 = Highcharts.chart('container2', {
                                title: {
                                  text: 'Jumlah Penderita Penyakit Pada Tahun <?php echo $tahun; ?>'
                                },
                        ...
                        <div class="row">
                          <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            $sql = "SELECT COUNT(IF(umur BETWEEN 0 and 4, 1, NULL)) AS '0 - 4', COUNT(IF(umur BETWEEN 5 and 9, 1, NULL)) AS '5 - 9', COUNT(IF(umur BETWEEN 10 and 14, 1, NULL)) AS '10 - 14', COUNT(IF(umur BETWEEN 15 and 19, 1, NULL)) AS '15 - 19', COUNT(IF(umur BETWEEN 20 and 24, 1, NULL)) AS '20 - 24', COUNT(IF(umur BETWEEN 25 and 29, 1, NULL)) AS '25 - 29', COUNT(IF(umur BETWEEN 30 and 34, 1, NULL)) AS '30 - 34', COUNT(IF(umur BETWEEN 35 and 39, 1, NULL)) AS '35 - 39', COUNT(IF(umur BETWEEN 40 and 44, 1, NULL)) AS '40 - 44', COUNT(IF(umur BETWEEN 45 and 49, 1, NULL)) AS '45 - 49', COUNT(IF(umur BETWEEN 50 and 54, 1, NULL)) AS '50 - 54', COUNT(IF(umur BETWEEN 55 and 59, 1, NULL)) AS '55 - 59', COUNT(IF(umur BETWEEN 60 and 64, 1, NULL)) AS '60 - 64', COUNT(IF(umur BETWEEN 65 and 69, 1, NULL)) AS '65 - 69', COUNT(IF(umur BETWEEN 70 and 74, 1, NULL)) AS '70 - 74', COUNT(IF(umur >= 75, 1, NULL)) AS '75 +' FROM tb_nama_penyakit WHERE YEAR(tanggal) = '$tahun'";
                            ...
                            // mengambil value atau nilai pada array
                            $jm_umur = array_values($result);
                            // untuk umur
                            $ju = json_encode($umur);
                            // untuk jumlah umur
                            $jpu = json_encode($jm_umur, JSON_NUMERIC_CHECK);
                            ...
                            <br />
                            <button class="btn btn-default" id="plain2">Plain</button>
                            <button class="btn btn-default" id="inverted2">Inverted</button>
                            <button class="btn btn-default" id="polar2">Polar</button>

                            <script type="text/javascript">
                              var chart2 = Highcharts.chart('container3', {
                                title: {
                                  text: 'Jumlah Penderita Penyakit Umur Pada Tahun <?php echo $tahun; ?>'
                                },
